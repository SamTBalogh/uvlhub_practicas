...
class FeatureModel(db.Model):
    ...
    files = db.relationship("Hubfile", backref="feature_model", lazy=True, cascade=CASCADE_DELETE)
    fm_meta_data = db.relationship("FMMetaData", uselist=False, backref="feature_model", cascade=CASCADE_DELETE)
...
class FMMetaData(db.Model):
    ...
    authors = db.relationship(
        "Author", backref="fm_metadata", lazy=True, cascade=CASCADE_DELETE, foreign_keys=[Author.fm_meta_data_id]
    )
